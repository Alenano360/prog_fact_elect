...
{
    public class ImpresionMovimientoSaldo
    {
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            graphics.DrawString("Ingreso de saldo", stringFont,
                    sb, startX, startY + Offset);
            Offset = Offset + 16;

            graphics.DrawString("Cliente: " + _ClienteS.ToString(), stringFont,
                    sb, startX, startY + Offset);
            Offset = Offset + 16;
            ...
            graphics.DrawString(": " + DateTime.Now.ToShortDateString(), stringFont,
                    sb, startX + 80, startY + Offset);
            Offset = Offset + 16;

            graphics.DrawString("Saldo Anterior", stringFont,
                    sb, startX, startY + Offset);

            graphics.DrawString(": " + (_Saldo).ToString("F"), stringFont,
                    sb, startX + 80, startY + Offset);
            Offset = Offset + 16;

            graphics.DrawString("Abono", stringFont,
                    sb, startX, startY + Offset);
            ...
            graphics.DrawString("Saldo Actual", stringFont,
                    sb, startX, startY + Offset);

            graphics.DrawString(": " + (_Monto+_Saldo).ToString("F"), stringFont,
                    sb, startX + 80, startY + Offset);
            Offset = Offset + 48;
