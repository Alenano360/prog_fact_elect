...
{
    public partial class ComandaBar : Form
    {
        Login _owner;
        ...
        private void ComandaBar_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                MessageBox.Show("Hubo un inconveniente al cargar la información de la comanda del bar: " + ex.Message, "Validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ObtienePorEntregar()
        {
            try
            {
                this.objComandaBar.ObtieneComandaBar();

                int locx = 30;
                int locy = 75;

                foreach (string item in this.objComandaBar.ListaComandaBar)
                {
                    ...
                    this.panelBar.Controls.Add(lbl);
                    ...
                    this.panelBar.Controls.Add(lblCantidad);
                    ...
                    this.panelBar.Controls.Add(lblMesa);
                    ...
                    this.panelBar.Controls.Add(btn);
            ...
            {
                MessageBox.Show("Hubo un inconveniente al cargar la comanda del bar: " + ex.Message, "Validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void btnEntregaOrden(object sender, EventArgs e)
        {
            try
            {
                ...
                this.objComandaBar.TemporalConsumoId = Convert.ToInt32(id);
                ...
                //    lbl1.Location = new Point(50 , 40);
                //}
                //this.gbEntregar.Controls.Add(lbl1);
                ...
                //    lbl2.Location = new Point(350, 40);
                //}
                //this.gbEntregar.Controls.Add(lbl2);
                ...
                //    lbl3.Location = new Point(625, 40);
                //}
                //this.gbEntregar.Controls.Add(lbl3);
                ...
                //    lbl4.Location = new Point(800, 40);
                //}
                //this.gbEntregar.Controls.Add(lbl4);
        ...
        private void ComandaBar_Resize(object sender, EventArgs e)
        {
            try
            {
                this.ResizeLoad();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                this.ObtienePorEntregar();
                //this.lblTitulo.Text = x.ToString();
                //x++;
            }
            catch (Exception)
            {
