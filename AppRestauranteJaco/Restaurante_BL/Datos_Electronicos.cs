    ...
    public class Datos_Electronicos
    {
        ...
        public bool Guardar_Factura()
        {
            ...
            try
            {
                ...
                Restaurante_DAL.Facturas_Electronicas Factura = new Restaurante_DAL.Facturas_Electronicas();
        ...
        public List<Restaurante_DAL.Tiquetes_Electronicos> Buscar_TicketXlocal(int numlocal)
        {
            OpenConn();
            return db.Tiquetes_Electronicos.Where(x => x.Numero_Factura_Local == numlocal).ToList();
        }

        public List<Restaurante_DAL.Facturas_Electronicas> Buscar_FacturaXlocal(int numlocal)
        {
            OpenConn();
        ...
        public bool Guardar_Tiquete()
        {
            ...
            try
            {
                ...
                Restaurante_DAL.Tiquetes_Electronicos Tiquete = new Restaurante_DAL.Tiquetes_Electronicos();
        ...
        //Factutas 
        public List<Restaurante_DAL.Facturas_Electronicas> Get_FacturasXFecha(DateTime desde, DateTime Hasta)
        {
            OpenConn();
            return db.Facturas_Electronicas.Where(x => desde <= x.Fecha && x.Fecha <= Hasta && x.Cancelada == false).ToList();
        }
        public List<Restaurante_DAL.Facturas_Electronicas> Get_Facturas_NoEnvidas()
        {
            OpenConn();
            return db.Facturas_Electronicas.Where(x => x.Enviada == false && x.Cancelada == false).ToList();
        }

        public List<Restaurante_DAL.Facturas_Electronicas> Get_Facturas_Cancelada(DateTime desde, DateTime Hasta)
        {
            OpenConn();
        ...
        //Tiquetes 
        public List<Restaurante_DAL.Tiquetes_Electronicos> Get_TiquetesXFecha(DateTime desde, DateTime Hasta)
        {
            OpenConn();
            return db.Tiquetes_Electronicos.Where(x => desde <= x.Fecha && x.Fecha <= Hasta && x.Cancelada == false).ToList();
        }
        public List<Restaurante_DAL.Tiquetes_Electronicos> Get_Tiquetes_NoEnviados()
        {
            OpenConn();
            return db.Tiquetes_Electronicos.Where(x => x.Enviada == false && x.Cancelada == false).ToList();
        }

        public List<Restaurante_DAL.Tiquetes_Electronicos> Get_Tiquetes_Cancelada(DateTime desde, DateTime Hasta)
        {
            OpenConn();
