...
namespace PuntoVentaBL
{
    ...
    public class ImpresionProforma
    {
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, new Font("Times New Roman", 6, FontStyle.Bold), sb, 830 - stringSize.Width - startX, startY + Offset);
           
            //graphics.DrawString("DOCUMENTO NO VÁLIDO COMO FACTURA", new Font("Times New Roman",7, FontStyle.Bold),
            //      new SolidBrush(Color.Black), startX, startY + Offset);
            //Offset = Offset + 16;
            ...
            graphics.DrawString("Fecha: " + _Fecha + " " + _Hora, new Font("Merchant Copy Doublesize", 7),
                        new SolidBrush(Color.Black), startX, startY + Offset);
            Offset = Offset + 16;
       ...
       new SolidBrush(Color.Black), Convert.ToInt32(170), startY + Offset);
            ...
            foreach (string item in Articulos)
            {
                ...
                graphics.DrawString(temp[3].ToUpper(), new Font("Merchant Copy Doublesize", 7),
                    new SolidBrush(Color.Black), startX, startY + Offset);
                //if (temp[1].ToUpper().Length>65)
                //{
                //    graphics.DrawString(temp[1].ToUpper().Substring(0,64), stringFont, sb, startX + 80, startY + Offset); //desc
                //}
                //else
                //{
                ...
                //measureString=Convert.ToDecimal(temp[2].ToUpper()).ToString("#,##.#0");
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb, 525 - stringSize.Width, startY + Offset);//entre menos mas a la izquierda//cantidad


                graphics.DrawString(temp[5].ToUpper(), new Font("Merchant Copy Doublesize", 7),
                        new SolidBrush(Color.Black), Convert.ToInt32(170), startY + Offset);
                Offset = Offset + 16;
               
                //measureString = temp[3].ToUpper();
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb, 620 - stringSize.Width, startY + Offset);//precio
                //measureString = temp[3].ToUpper();
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb,185 - stringSize.Width, startY + Offset);//precio


                //measureString = temp[4].ToUpper().ToString();
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb, 700 - stringSize.Width, startY + Offset);//porcdesc
                //measureString = temp[4].ToUpper().ToString();
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb,245 - stringSize.Width, startY + Offset);//porcdesc


                //measureString = Convert.ToDecimal(temp[5].ToUpper()).ToString("#,##.#0");
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
                //graphics.DrawString(measureString, stringFont, sb, 830 - stringSize.Width-startX, startY + Offset);//total
                //Offset = Offset + 16;
                //measureString = Convert.ToDecimal(temp[5].ToUpper()).ToString("#,##.#0");
                //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            ...
            //stringFont = new Font("Times New Roman", 9);

            //this.OpenConn();

            //var anexo = (from a in db.Proforma_Anexos
            //             where a.ProformaId == _FacturaId
            //             select a).First();

      
            //measureString = "VIGENCIA DE LA OFERTA:";
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb,170 - stringSize.Width, startY + Offset);

            //measureString = anexo.VigenciaOferta;
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb,170, startY + Offset);
            //Offset = Offset + 16;

         
            //measureString = "ATENCION A:";
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 100 - stringSize.Width, startY + Offset);

            //measureString = anexo.AtencionA;
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 100, startY + Offset);
            //Offset = Offset + 16;

            //measureString = "TIEMPO DE ENTREGA:";
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 150 - stringSize.Width, startY + Offset);

            //measureString = anexo.TiempoEntrega;
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 150, startY + Offset);
            //Offset = Offset + 16;

 
            //measureString = "CONDICIONES DE PAGO:";
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 160 - stringSize.Width, startY + Offset);

            //measureString = anexo.CondicionPago;
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 160, startY + Offset);
            //Offset = Offset + 16;

           
            //measureString = "OBSERVACIONES:";
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 150 - stringSize.Width, startY + Offset);

            //measureString = anexo.Comentarios;
            //stringSize = e.Graphics.MeasureString(measureString, stringFont);
            //graphics.DrawString(measureString, stringFont, sb, 150, startY + Offset);
            //Offset = Offset + 16;
