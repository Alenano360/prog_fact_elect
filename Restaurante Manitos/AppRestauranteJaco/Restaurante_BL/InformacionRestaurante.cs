        ...
        public void ActualizaInformacionRestaurantes()
        {
            try
            {
                ...
                if (bus.Count() > 0)
                {
                    ...
                    bu.Numero_Cedula = Convert.ToInt64(_Numero_Cedula);
                    bu.Numero_Sucursal = Convert.ToInt64(_Numero_Sucursal);
                ...
                else
                {
                    ...
                    _NewInformacionGeneral.Numero_Cedula = Convert.ToInt64(_Numero_Cedula);
                    _NewInformacionGeneral.Numero_Sucursal = Convert.ToInt64(_Numero_Sucursal);
