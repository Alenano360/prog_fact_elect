...
namespace Restaurante_Presentacion
{
    public partial class Principal : Form
    {
        ...
        private void btnMesa80_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 80;
            menu.TopLevel = false;
        ...
        private void btnMesa81_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 81;
            menu.TopLevel = false;
        ...
        private void btnMesa82_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 82;
            menu.TopLevel = false;
        ...
        private void btnMesa83_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 83;
            menu.TopLevel = false;
        ...
        private void btnMesa84_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 84;
            menu.TopLevel = false;
        ...
        private void btnMesa85_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 85;
            menu.TopLevel = false;
        ...
        private void btnMesa86_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 86;
            menu.TopLevel = false;
        ...
        private void btnMesa87_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 87;
            menu.TopLevel = false;
        ...
        private void btnMesa88_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 88;
            menu.TopLevel = false;
        ...
        private void btnMesa89_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 89;
            menu.TopLevel = false;
        ...
        private void btnMesa90_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 90;
            menu.TopLevel = false;
        ...
        private void btnMesa91_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 91;
            menu.TopLevel = false;
        ...
        private void btnMesa92_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 92;
            menu.TopLevel = false;
        ...
        private void btnMesa93_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 93;
            menu.TopLevel = false;
        ...
        private void btnMesa94_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 94;
            menu.TopLevel = false;
        ...
        private void btnMesa95_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 95;
            menu.TopLevel = false;
        ...
        private void btnMesa96_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 96;
            menu.TopLevel = false;
        ...
        private void btnMesa97_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 97;
            menu.TopLevel = false;
        ...
        private void btnMesa98_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 98;
            menu.TopLevel = false;
        ...
        private void btnMesa99_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 99;
            menu.TopLevel = false;
        ...
        private void btnMesa100_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 100;
            menu.TopLevel = false;
        ...
        private void btnMesa101_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 101;
            menu.TopLevel = false;
        ...
        private void btnMesa102_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 102;
            menu.TopLevel = false;
        ...
        private void btnMesa103_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 103;
            menu.TopLevel = false;
        ...
        private void btnMesa104_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 104;
            menu.TopLevel = false;
        ...
        private void btnMesa105_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 105;
            menu.TopLevel = false;
        ...
        private void btnMesa106_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 106;
            menu.TopLevel = false;
        ...
        private void btnMesa107_Click(object sender, EventArgs e)
        {
            Menu_Orden menu = new Menu_Orden(this);
            menu.MesaActual = 107;
            menu.TopLevel = false;
